const telefonia = [
    ...
    },
    {
        ...
        category: 'Telefonía',
        description:
            'Es un teléfono muy facil de usar, no consume mucha bateria',
        price: '45',
        namePhoto: {
    ...
    },
    {
        ...
        category: 'Telefonía',
        description:
            'Es un teléfono que ha hecho historia, y el cual es buscado por coleccionistas y amantes de lo bueno, Perteneciente a la segunda generación de telefonía móvil (2G).',
        price: '50',
        namePhoto: {
