...
return (
    <div className= "DesplegarMenu">
     <Dropdown isOpen={dropdown} toggle={abrirCerrarDropdown}>
        ...
        <DropdownMenu>
            <DropdownItem><Link to ='/editarUsuario'>Editar Usuario</Link></DropdownItem>
            <DropdownItem><Link to ='/ventas'>Vender tu producto</Link></DropdownItem>
            <DropdownItem><Link to ='/mensajes/:idProduct/mensajes'>Buzon de Mensajes</Link></DropdownItem>
