...
export const Perfil = () => {
  ...
  useEffect(() => {
    ...
    get('http://localhost:4000/users',(body)=>{

    return  setUser(body.userInfo),setProduct(body.userInfo.products)}, token)
            ...
            {products.map((el) => (
              <li>
                <ul>
                  ...
                  <li>Fecha de publicación:{el.creali}</li>
                  <li>ID :{el.id}</li>
                  <li>----------------</li>
                </ul>
              </li>
